...
import LeftImg from "../assets/images/1LeftImg.webp";
import RightImg from "../assets/images/2RightImg.webp";
  ...
  return (
    <div>
      ...
      <div className="flex xl:flex-row flex-col items-center justify-center pb-20">
        <img className="md:max-w-3xl p-4 lg:pl-14" src={LeftImg} />
        <img className="md:max-w-3xl p-4 lg:pr-14" src={RightImg} />
      </div>
    </div>
  );
}
